...
- **Aircraft**: Choose aircraft and optional livery. This menu does not actually check which aircraft are installed, but will refer to a public database.
...
- **Time & Date**: Sync to current time or set manually (UTC or departure airport time zone).
