...
- [ ] Adding a GUI client which seamlessly integrates into desktop operating systems.
- [ ] Adding a MCP server to allow flight plans to be generated with a choice of LLMs.
