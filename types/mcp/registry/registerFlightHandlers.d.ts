...
export declare function registerFlightHandlers(server: McpServer, flightService: AeroflyFlightService): void;
//# sourceMappingURL=registerFlightHandlers.d.ts.map