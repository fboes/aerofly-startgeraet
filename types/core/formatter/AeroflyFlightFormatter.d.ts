...
export declare function getMinuteString(minutes: number): string;
...
export declare function getVisibility(aeroflyFlight: AeroflyFlight, separator?: string): string;
export declare function getClouds(aeroflyFlight: AeroflyFlight, join?: string): string;
