...
<a href="https://github.com/fboes/aerofly-startgeraet">GitHub</a> &middot; &copy; 2026
    ...
    async connectedCallback() {
        ...
        if (applicationName && applicationVersion) {
            applicationName.textContent = await window.applicationService?.getApplicationName() ?? "Aerofly Startgerät";
            applicationVersion.textContent = await window.applicationService?.getApplicationVersion() ?? "unknown version";
        }
    }
