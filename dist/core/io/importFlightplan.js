...
export function getFlightplansFromFile(filename) {
    const content = fs.readFileSync(filename, "utf8");
    return getFlightplansFromString(content, filename);
}
export function getFlightplansFromString(content, filename) {
 ...
 */
export function importFile(filename, flightplan, index = 0) {
    const content = fs.readFileSync(filename, "utf8");
 ...
 * @see importFile
 */
export function importString(content, filename, flightplan, index = 0) {
    const converter = getImportConverter(filename);
    new converter().convert(content, flightplan, index);
}
export function getImportConverter(filename) {
