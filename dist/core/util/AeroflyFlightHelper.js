 ...
 */
export function getDepartureTimeZone(aeroflyFlight) {
...
export function getIcaoFlightCategory(aeroflyFlight) {
    const ceiling = getCeiling(aeroflyFlight);
    return aeroflyFlight.visibility_meter >= 5000 && (!ceiling?.height_ft || ceiling.height_ft >= 1500) ? "VFR" : "IFR";
}
export function getCeiling(aeroflyFlight) {
...
export function getTimeAndDateDeparture(aeroflyFlight) {
