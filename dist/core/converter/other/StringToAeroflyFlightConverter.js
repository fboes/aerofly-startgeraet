 ...
 */
export class XMLToAeroflyFlightConverter extends StringToAeroflyFlightConverter {
    getXmlNode(xml, tag) {
...
export class JSONToAeroflyFlightConverter extends StringToAeroflyFlightConverter {
    getJSONArray(json) {
