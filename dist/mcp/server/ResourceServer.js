...
export class ResourceServer {
    ...
    static registerResources(server, resourceService) {
        server.registerResource("aircraft", `${AeroflyFlightMcpResourceService.RESOURCE_NAME_SPACE}/aircraft`, {
        ...
        server.registerResource("aircraft-detail", new ResourceTemplate(`${AeroflyFlightMcpResourceService.RESOURCE_NAME_SPACE}/aircraft/{aeroflyCode}`, {
            list: async () => ({
        ...
        server.registerResource("aircraft-tags", `${AeroflyFlightMcpResourceService.RESOURCE_NAME_SPACE}/aircraft-tags`, {
        ...
        server.registerResource("airport", new ResourceTemplate(`${AeroflyFlightMcpResourceService.RESOURCE_NAME_SPACE}/airports/{icaoCode}`, {
            list: async () => ({
        ...
        server.registerTool("search-aircraft", {
            ...
            inputSchema: {
                query: z
                    .string()
                    .optional()
                    .describe(`Aerofly FS 4 code, ICAO code, (partial) name of aircraft or (partial) name of livery name available for aircraft. Call ${AeroflyFlightMcpResourceService.RESOURCE_NAME_SPACE}/aircraft to see a list of all available ICAO or Aerofly FS4 codes.`),
                tags: z
                    .array(z.string())
                    .optional()
                    .describe(`Tags like 'airliner' or 'military'. If multiple tags are submitted, the will be linked via \`OR\`. all ${AeroflyFlightMcpResourceService.RESOURCE_NAME_SPACE}/aircraft-tags to see a list of all available tags.`),
            ...
            content: [
                {
                    type: "text",
                    text: this.JSONstrinigify(resourceService.searchAircraft({ query, tags, minimumRangeNm, minimumCruiseSpeedKts })),
                },
            ],
        }));
