...
export class AeroflyFlightMcpService {
    ...
    getAircraftRessources() {
        return AeroflyAircraftService.getAllAircraftLiveries().map((a) => {
            return {
                uri: `${AeroflyFlightMcpService.RESOURCE_NAME_SPACE}/aircraft/${a.aeroflyCode}`,
    ...
    searchAircraft({ query = undefined, tags = undefined, minimumRangeNm = undefined, minimumCruiseSpeedKts = undefined, } = {}) {
    ...
    getAirportRessources() {
        return [AeroflyAirportService.getAirportByIcaoCode("KEYW"), AeroflyAirportService.getAirportByIcaoCode("EHAM")]
            ...
            .map((a) => {
            return {
                uri: `${AeroflyFlightMcpService.RESOURCE_NAME_SPACE}/airports/${a.code}`,
                name: `Airport: ${a.name}`,
