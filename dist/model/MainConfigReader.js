import { AeroflyFlight, AeroflyNavigationConfig, AeroflyNavRouteApproach, AeroflyNavRouteArrival, AeroflyNavRouteDeparture, AeroflyNavRouteDepartureRunway, AeroflyNavRouteDestination, AeroflyNavRouteDestinationRunway, AeroflyNavRouteOrigin, AeroflyNavRouteWaypoint, AeroflySettingsAircraft, AeroflySettingsCloud, AeroflySettingsFlight, AeroflySettingsFuelLoad, AeroflySettingsWind, AeroflyTimeUtc, } from "@fboes/aerofly-custom-missions";
...
export class MainConfigReader {
    ...
    getFallback() {
        return new AeroflyFlight(new AeroflySettingsAircraft("c172", ""), new AeroflySettingsFlight(-81.76, 24.5, 0, 0, 0), new AeroflyTimeUtc(new Date()), new AeroflySettingsWind(0, 0, 0), [], new AeroflyNavigationConfig(0, [
