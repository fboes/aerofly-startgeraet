 ...
 */
export abstract class XMLToAeroflyFlightConverter extends StringToAeroflyFlightConverter {
...
export abstract class JSONToAeroflyFlightConverter extends StringToAeroflyFlightConverter {
