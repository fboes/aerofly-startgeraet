...
export function getConverter(filename: string): new () => StringToAeroflyFlightConverter {
...
function getRegistry(): Record<string, (new () => StringToAeroflyFlightConverter) | undefined> {
    return {
        [AeroflyCustomMissionsTmcToAeroflyFlightConverter.fileExtension]:
