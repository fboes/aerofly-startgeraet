...
function registerResources(server: McpServer) {
    server.registerResource(
        ...
        (uri: URL): ReadResourceResult =>
            returnMcpResourceResult(AeroflyFlightMcpResourceService.getAircraftList(), uri, MIME_TYPE_RESPONSE),
    );
    ...
    server.registerResource(
        ...
        (uri: URL, { aeroflyCode }: Variables): ReadResourceResult =>
            returnMcpResourceResult(
                AeroflyFlightMcpResourceService.getAircraft(String(aeroflyCode)),
                uri,
                MIME_TYPE_RESPONSE,
            ),
    );
    ...
    server.registerResource(
        ...
        (uri: URL): ReadResourceResult =>
            returnMcpResourceResult(AeroflyFlightMcpResourceService.getAircraftTags(), uri, MIME_TYPE_RESPONSE),
    );
    ...
    server.registerResource(
        ...
        (uri: URL, { icaoCode }: Variables): ReadResourceResult =>
            returnMcpResourceResult(
                AeroflyFlightMcpResourceService.getAirport(String(icaoCode)),
                uri,
                MIME_TYPE_RESPONSE,
            ),
    );
...
function registerTools(server: McpServer) {
    ...
    server.registerTool(
        ...
        ({
            ...
            returnMcpToolSimpleResult(
                AeroflyFlightMcpResourceService.searchAircraft({ query, tags, minimumRangeNm, minimumCruiseSpeedKts }),
            ),
    );
    ...
    server.registerTool(
        ...
        ({
            ...
            returnMcpToolSimpleResult(AeroflyFlightMcpResourceService.searchAirports({ query, geoQuery })),
    );
