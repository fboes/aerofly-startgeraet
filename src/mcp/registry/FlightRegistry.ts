...
export class FlightRegistry {
    ...
    static registerTools(server: McpServer, flightService: AeroflyFlightService): void {
        ...
        server.registerTool(
            FlightRegistry.METHOD_GET_FLIGHT,
            {
        ...
        server.registerTool(
            FlightRegistry.METHOD_SET_WEATHER,
            {
        ...
        server.registerTool(
            FlightRegistry.METHOD_SET_CLOUDS,
            {
        ...
        server.registerTool(
            FlightRegistry.METHOD_SAVE_FLIGHT,
            {
